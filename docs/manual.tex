...
\tikzstyle{selcircbutton}=[font=\tiny,circle,line width=1mm,draw=green!80, fill=black, text=white, minimum height=1.2cm,minimum width=1.2cm]
...
\begin{tikzpicture}[align=center, node distance=1.5cm and 0.5cm]
  ...
  \node [mhbutton, right of=3] (4) {NOISE};
  \node [mhbutton, right of=4] (5) {DMC};
  \node [mbutton, right of=5] (6) {LFO1};
  \node [mbutton, right of=6] (7) {LFO2};
  \node [mbutton, right of=7] (8) {LFO3};
...
\begin{tikzpicture}[align=center, node distance=1.5cm]
  ...
  \node [dummybutton, below=9] (17) {};
  \node [dummybutton, right of=17] (18) {};
  \node [circbutton, right of=18] (19) {PROGRAM};
  \node [circbutton, right of=19] (20) {PAGE 2};
  \node [selcircbutton, right of=20] (21) {SEQ.};
  \node [circbutton, right of=21] (22) {SETTINGS};
  \node [dummybutton, right of=22] (23) {};
  \node [dummybutton, right of=23] (24) {};

  \node [hcircbutton, below=17] (25) {PLAY/\\STOP};
  \node [hcircbutton, right of=25] (26) {SAVE};
  \node [dummybutton, right of=26] (27) {};
  \node [dummybutton, right of=27] (28) {};
  \node [dummybutton, right of=28] (29) {};
  \node [dummybutton, right of=29] (30) {};
  \node [hcircbutton, right of=30] (31) {UP};
  \node [hcircbutton, right of=31] (32) {DOWN};
\end{tikzpicture}
...
\begin{tikzpicture}[align=center, node distance=1.5cm, auto]
  ...
  \node [hcircbutton, below=1] (8) {BACK};
  \node [circbutton, right of=8] (9) {};
  \node [dummybutton, right of=9] (10) {};
  \node [dummybutton, right of=10] (11) {};
  \node [dummybutton, right of=11] (12) {};
  \node [dummybutton, right of=12] (13) {};
  \node [circbutton, right of=13] (14) {UP};
  \node [circbutton, right of=14] (15) {DOWN};
\end{tikzpicture}
...
\begin{tikzpicture}[align=center, node distance=1.5cm, auto]
  ...
  \node [hcircbutton, below=1] (8) {BACK};
  \node [hcircbutton, right of=8] (9) {SET};
  \node [dummybutton, right of=9] (10) {};
  \node [dummybutton, right of=10] (11) {};
  \node [dummybutton, right of=11] (12) {};
  \node [dummybutton, right of=12] (13) {};
