...
In the programming mode, the various parameters of the sound channels and LFOs can be changed. A set of channel and LFO settings are collectively known as a \emph{patch}, to adhere to the long tradition of synthesizer nomenclature. The \name can save patches to memory, and has room for 100 patches. 
...
\begin{tikzpicture}[align=center, node distance=1.5cm, auto]
  ...
  \node [circbutton, right of=3] (4) {PATTERN};
...
To save a patch, press \btn{SAVE}. The button will start to blink to indicate that you can select where to store the new patch. Use the \lbl{DATA} knob or \btn{UP} and \btn{DOWN} to select where to store the patch. Press \btn{SAVE} again to store the patch at the selected location. 
...
\subsection{Note assignment and arpeggiator}
...
\begin{tikzpicture}[align=center, node distance=1.5cm and 0.5cm]
  ...
  \node [mbutton, right of=3] (4) {NOISE};
  \node [mbutton, right of=4] (5) {DMC};
  \node [button, right of=5] (6) {};
  \node [button, right of=6] (7) {};
  \node [button, right of=7] (8) {};

  \node [hbutton, below=1] (9) {\textcolor{yellow}{ARP RNG}};
  \node [hbutton, right of=9] (10) {\textcolor{yellow}{ARP MODE}};
  \node [hbutton, right of=10] (11) {\textcolor{yellow}{ARP CHAN}};
  \node [hbutton, right of=11] (12) {\textcolor{yellow}{ARP RATE}};
  \node [hbutton, right of=12] (13) {\textcolor{yellow}{ARP SYNC}};
  \node [hbutton, right of=13] (14) {\textcolor{yellow}{MONO}};
  \node [hbutton, right of=14] (15) {\textcolor{yellow}{POLY 1}};
  \node [hbutton, right of=15] (16) {\textcolor{yellow}{POLY 2}};
\end{tikzpicture}
...
In the sequencer mode, 16-note sequence patterns can be created and played back. The sequencer is somewhat more complicated to use than the programmer. The user interface employs several \emph{levels}.
...
\begin{tikzpicture}[align=center, node distance=1.5cm]
  ...
  \node [mhbutton, right of=3] (4) {NOISE};
  \node [mhbutton, right of=4] (5) {DMC};
  \node [button, right of=5] (6) {TEMPO};
  \node [button, right of=6] (7) {EXT SYNC};
  \node [button, right of=7] (8) {};
  ...
  \node [hcircbutton, below= of 9] (17) {PLAY};
  \node [hcircbutton, right of=17] (18) {SAVE};
...
To play back a selected sequence, press \btn{PLAY}. The sequence will loop indefinitely. Press \btn{PLAY} again to stop it.
...
\begin{tikzpicture}[align=center, node distance=1.5cm, auto]
  ...
  \node [hcircbutton, below= of 9] (17) {PLAY};
  \node [hcircbutton, right of=17] (18) {BACK};
  \node [dummybutton, right of=18] (19) {};
  \node [dummybutton, right of=19] (20) {};
  \node [dummybutton, right of=20] (21) {};
  \node [dummybutton, right of=21] (22) {};
  \node [circbutton, right of=22] (23) {UP};
  \node [circbutton, right of=23] (24) {DOWN};
\end{tikzpicture}
...
\begin{tikzpicture}[align=center, node distance=1.5cm, auto]
  ...
  \node [hbutton, right of=6] (7) {LENGTH};
  \node [hbutton, right of=7] (8) {OCTAVE};
  ...
  \node [hcircbutton, below= of 9] (17) {CLEAR};
  \node [hcircbutton, right of=17] (18) {SET};
  \node [dummybutton, right of=18] (19) {};
  \node [dummybutton, right of=19] (20) {};
  \node [dummybutton, right of=20] (21) {};
  \node [dummybutton, right of=21] (22) {};
...
When you're done, press \btn{SET} to store the note. If you want to delete the note, press \btn{CLEAR}. In either case, the sequencer will return to the pattern editing mode. 
